...
/* post/show.html.twig */
class __TwigTemplate_917ebfdffb4171a8b5d5eadb569d8d7b7ceca3aea65b97daa916b3e5384b1a85 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            ";
        // line 15
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["post"] ?? null), "getUser", [], "any", false, true, false, 15), "getFirstName", [], "any", true, true, false, 15)) {
            // line 16
            echo "                <td>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 16, $this->source); })()), "getUser", [], "any", false, false, false, 16), "getFirstName", [], "any", false, false, false, 16), "html", null, true);
            echo "</td>
            ";
        }
        // line 18
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 28, $this->source); })()), "file", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Status</th>
                <td>";
        // line 32
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 32, $this->source); })()), "status", [], "any", false, false, false, 32)) ? ("Yes") : ("No"));
        echo "</td>
            </tr>
            <tr>
                <th>comment</th>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["post"], "getYes", [], "any", false, false, false, 36));
...
";
    ...
    {
        return array (  171 => 47,  166 => 45,  161 => 43,  155 => 39,  146 => 37,  142 => 36,  135 => 32,  128 => 28,  121 => 24,  114 => 20,  110 => 18,  104 => 16,  102 => 15,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <th>User</th>
            {% if post.getUser.getFirstName is defined %}
...
{% endblock %}
", "post/show.html.twig", "/var/www/project/templates/post/show.html.twig");
    }
}
